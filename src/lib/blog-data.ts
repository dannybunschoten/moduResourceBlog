        ...
        subsections: [
          {
            ...
            actionItems: [
              ...
              },
              {
                id: "COR-002",
                description:
                  "Apply anti-corrosive coating to exposed metal surfaces",
                priority: "Medium",
            ...
            actionItems: [
              {
                id: "COR-003",
                description:
                  "Inspect secondary support elements for signs of deterioration",
                priority: "Medium",
            ...
            actionItems: [
              {
                id: "COR-004",
                description:
                  "Replace damaged protective barriers in high-traffic areas",
                priority: "High",
            ...
            actionItems: [
              {
                id: "ELEC-001",
                description:
                  "Replace outdated circuit breakers in control room",
                priority: "High",
            ...
            actionItems: [
              {
                id: "EQP-001",
                description:
                  "Recalibrate pressure sensors on all CAT equipment",
                priority: "Medium",
                assignee: "Technical Team",
                dueDate: "July 5, 2024",
              },
              {
                id: "EQP-002",
                description:
                  "Conduct comprehensive diagnostic assessment of equipment performance metrics",
                priority: "High",
            ...
            actionItems: [
              {
                id: "EQP-003",
                description:
                  "Implement predictive maintenance schedule for critical equipment",
                priority: "High",
                assignee: "Maintenance Team",
            ...
            actionItems: [
              {
                id: "SFT-001",
                description:
                  "Replace expired fire extinguishers in sections C and D",
                priority: "High",
                assignee: "Safety Team",
                dueDate: "June 20, 2024",
              },
              {
                id: "SFT-002",
                description:
                  "Conduct comprehensive safety equipment functionality test",
                priority: "High",
                assignee: "Safety Team",
                dueDate: "June 25, 2024",
              },
            ...
            actionItems: [
              {
                id: "SFT-003",
                description:
                  "Update and conduct emergency response team training",
                priority: "High",
